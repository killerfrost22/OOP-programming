...
public class MarqueeDataManager implements DataManager{
		...
		private Cell[][] shiftOverArray;
		private int height= ConfigValues.MARQUEE_HEIGHT;
		private int length = ConfigValues.MARQUEE_WIDTH;
		...
		public MarqueeDataManager(String message, int animationPattern) {
			...
			shiftOverArray = appendCell(shiftOverArray,generateEmptyCellsArray(ConfigValues.MARQUEE_HEIGHT, ConfigValues.MARQUEE_WIDTH));
		}
