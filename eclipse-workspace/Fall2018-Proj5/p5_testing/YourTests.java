...
public class YourTests {
	...
	@Test
	public void testAdd() {
		CubicPoly term1 = new CubicPoly(
				new DoubleWithAppx(1),
				new DoubleWithAppx(1),
				new DoubleWithAppx(1),
				new DoubleWithAppx(1)
			);
		CubicPoly ter2 = new CubicPoly(
				new DoubleWithAppx(2),
				new DoubleWithAppx(2),
				new DoubleWithAppx(2),
				new DoubleWithAppx(2)
			);
		CubicPoly ter3 = new CubicPoly(
				new DoubleWithAppx(3),
				new DoubleWithAppx(3),
				new DoubleWithAppx(3),
				new DoubleWithAppx(3)
			);		
				assertEquals(term1.add(ter2),ter3);
	...
	public void testSubtract() {
		...
		CubicPoly ter3 = new CubicPoly(
				...
				assertEquals(term1.subtract(ter2),ter3);
	}
	...
	public void testDeriv() {
		...
		CubicPoly ter2 = new CubicPoly(
				new DoubleWithAppx(0),
				new DoubleWithAppx(3),
				new DoubleWithAppx(2),
				new DoubleWithAppx(1)
			);
		assertEquals(term1.deriv(), ter2);
	}
